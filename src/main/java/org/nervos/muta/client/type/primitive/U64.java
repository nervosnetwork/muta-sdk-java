...
public class U64 {
  ...
  public static void main(String[] args) throws JsonProcessingException {
    ...
    String se = objectMapper.writeValueAsString(U64.fromLong(1234));
    System.out.println(se);

    U64 de = objectMapper.readValue(se, U64.class);
  ...
  public static class U64Deserializer extends StdDeserializer<U64> {
    ...
    @Override
    public U64 deserialize(JsonParser jsonParser, DeserializationContext ctxt) throws IOException {
